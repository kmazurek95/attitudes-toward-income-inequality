...
See [docs/LITERATURE_REVIEW.md](docs/LITERATURE_REVIEW.md) for a detailed literature review and [docs/LIMITATIONS.md](docs/LIMITATIONS.md) for a discussion of study limitations.
...
│   ├── LITERATURE_REVIEW.md    # Literature context
│   ├── LIMITATIONS.md          # Study limitations
│   ├── PIPELINE_ALIGNMENT.md   # R/Python comparison
...
- **Python (Streamlit)**: [attitudes-inequality.streamlit.app](https://attitudes-inequality.streamlit.app)
- **R (Shiny)**: [kmazurek.shinyapps.io/attitudes-inequality-r](https://kmazurek.shinyapps.io/attitudes-inequality-r)
