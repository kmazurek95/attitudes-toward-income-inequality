...
if model_type == "Two-Level Models":
    ...
    with col1:
        ...
        fig = create_icc_donut(icc, title="Intraclass Correlation Coefficient")
    ...
    if figures.get('coefficient_stability'):
        ...
        fig = create_model_progression_chart(
            ...
            title="Key Predictor Coefficient Across Model Specifications"
        )
        st.plotly_chart(fig, use_container_width=True)
    ...
    if estimates:
        fig = create_forest_plot(
            ...
            title="Effect of % Low-Income Households (b_perc_low40_hh)",
...
with tab_vif:
    ...
    # Placeholder VIF table
    vif_data = {
        'Variable': ['b_perc_low40_hh', 'age', 'education', 'b_pop_dens',
