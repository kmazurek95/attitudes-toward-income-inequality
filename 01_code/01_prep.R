...
score_final <- score %>%
  select(a27_1,a27_2, a27_3, b01, b02, b03, b04, b05, b06, b07, b08, b09, b10,
         ...
         b20, b21, b22, GENDERID, weegfac, Buurtcode, buurt_id,
...
names(score_final)[29] <- "gender"
names(score_final)[30] <- "weight"
names(score_final)[31] <- "buurtcode"
>>>>>>> db2ef623266de85ad2ba8c8fc1f8524cc2482403
...
# write.csv(complete_merge,"./03_data_final/complete_merge.csv")